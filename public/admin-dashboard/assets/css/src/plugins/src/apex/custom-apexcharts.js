window.addEventListener("load", function () {
    ...
    // recommendation tab js starts

    // var weeklyGainsOptions = {
    //     series: [{
    //         name: 'Net Profit',
    ...
    // recommendation tab js ends




    // Series data
    // var seriesData1 = [76, 26, 57, 30];
    // var seriesData2 = [76, 26];
    // var seriesData3 = [16, 66];

    // Calculate the total value
    // var totalValue1 = seriesData1.reduce((a, b) => a + b, 0);
    // var totalValue2 = seriesData2.reduce((a, b) => a + b, 0);
    // var totalValue3 = seriesData3.reduce((a, b) => a + b, 0);

    // Set the initial total value in the custom label
    // document.getElementById('call-status-label').innerText = totalValue1;
    // document.getElementById('mobile-app-label').innerText = totalValue2;
    // document.getElementById('total-subs-label').innerText = totalValue3;
    ...
    // var totalSubsChart = new ApexCharts(document.querySelector("#total-subs-chart"), totalSubsOptions);
    // totalSubsChart.render();
